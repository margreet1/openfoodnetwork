...
ActiveRecord::Schema.define(version: 20190321203818) do
  ...
  add_index "exchanges", ["payment_enterprise_id"], name: "index_exchanges_on_payment_enterprise_id", using: :btree
